...
Продвижение, монетизация и то, как не выгореть: психология, договорённости и площадки.
...
<div class="lw-wrap">
  <div class="lw-head">
    ...
    <span class="lw-head__label">Pipeline · путь продюсера</span>
    <span class="lw-count"><b>00</b>/10</span>
  </div>
  <div class="lw-flow">
    ...
    <li class="lw-step" style="--pc:#F2994A;--pb:rgba(242,153,74,0.4);--pg:rgba(242,153,74,0.35)">
      <div class="lw-node"><i data-lucide="target"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">01</span><h3>Навыки продакшна</h3><span class="lw-tag">База</span></div>
        <p>Синтез, сведение, мастеринг — база уже есть.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#F2994A;--pb:rgba(242,153,74,0.4);--pg:rgba(242,153,74,0.35)">
      <div class="lw-node"><i data-lucide="briefcase"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">02</span><h3>Свой звук и портфолио</h3><span class="lw-tag">База</span></div>
        <p>Портфолио треков, которые показывают ваш уровень.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#C084FC;--pb:rgba(192,132,252,0.4);--pg:rgba(192,132,252,0.35)">
      <div class="lw-node"><i data-lucide="git-branch"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">—</span><h3>Выбор пути</h3><span class="lw-tag">Ветвление</span></div>
        <p>Четыре направления — их можно совмещать.</p>
<div class="lw-chips"><span class="lw-chip"><i data-lucide="disc-3"></i>Битмейкер / Продакшн</span><span class="lw-chip"><i data-lucide="mic-vocal"></i>Артист / Исполнитель</span><span class="lw-chip"><i data-lucide="sliders-horizontal"></i>Сведение / Мастеринг</span><span class="lw-chip"><i data-lucide="sparkles"></i>Саунд-дизайнер</span></div>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="megaphone"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">03</span><h3>Соцсети и продвижение</h3><span class="lw-tag">Карьера</span></div>
        <p>Контент, аудитория и первые слушатели.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="store"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">04</span><h3>Площадки и стоки</h3><span class="lw-tag">Карьера</span></div>
        <p>Продажа битов на площадках и в стоках.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="send"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">05</span><h3>Дистрибуция на стриминги</h3><span class="lw-tag">Карьера</span></div>
        <p>Трек попадает в Spotify, Apple Music и другие.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="users"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">06</span><h3>Работа с клиентами</h3><span class="lw-tag">Карьера</span></div>
        <p>Артисты, бренды и заказчики.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="scale"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">07</span><h3>Договоры и права</h3><span class="lw-tag">Карьера</span></div>
        <p>Авторские права, роялти и контракты.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#34D399;--pb:rgba(52,211,153,0.4);--pg:rgba(52,211,153,0.35)">
      <div class="lw-node"><i data-lucide="trending-up"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">08</span><h3>Постоянное развитие</h3><span class="lw-tag">Рост</span></div>
        <p>Новые техники, оборудование и коллаборации.</p>
      </div>
    </li>
    <li class="lw-step lw-step--final" style="--pc:#34D399;--pb:rgba(52,211,153,0.4);--pg:rgba(52,211,153,0.35)">
      <div class="lw-node"><i data-lucide="crown"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">09</span><h3>Бренд и медийный образ<span class="lw-eq--mini" aria-hidden="true"><i></i><i></i><i></i></span></h3><span class="lw-tag">Рост</span></div>
        <p>Ваше имя становится брендом в индустрии.</p>
      </div>
    </li>
    </ol>
  </div>
...
!!! success "Тест Этапа №9"
    30 вопросов по всем темам этапа: цель пиара, соцсети, продажа битов и сведения, стоки, прогресс в продвижении, выкладывание трека на площадки, борьба с выгоранием, монетизация, отношения с артистами, договоры и права. Закрепи знания и навыки этапа — после каждого ответа мгновенный разбор: почему верно или где ошибся.
