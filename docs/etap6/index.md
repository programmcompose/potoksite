...
!!! success "Тест Этапа №6"
    48 вопросов по всем темам этапа: рок, пост-панк, гранж, метал, джаз и работа с реальными инструментами. Закрепи знания и навыки этапа — после каждого ответа мгновенный разбор: почему верно или где ошибся.
