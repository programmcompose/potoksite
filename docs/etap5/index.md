...
В этом этапе — синтез, сэмплирование, жанры EDM и саунд-дизайн: от синусоиды до дропа.
...
<div class="lw-wrap">
  <div class="lw-head">
    ...
    <span class="lw-head__label">Pipeline · EDM-продакшн</span>
  ...
  <div class="lw-flow">
    ...
    <li class="lw-step" style="--pc:#F2994A;--pb:rgba(242,153,74,0.4);--pg:rgba(242,153,74,0.35)">
      <div class="lw-node"><i data-lucide="lightbulb"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">01</span><h3>Идея + Референсы</h3><span class="lw-tag">Подготовка</span></div>
        <p>Собираем референсы и определяем характер трека.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">02</span><h3>Синтез звука / Сэмплирование</h3><span class="lw-tag">Создание</span></div>
        <p>Генерируем звуки с нуля или находим готовые сэмплы.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      <div class="lw-node"><i data-lucide="piano"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">03</span><h3>Создание синтов в Serum</h3><span class="lw-tag">Создание</span></div>
        <p>Пишем свои пресеты: осцилляторы, фильтры, LFO.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      <div class="lw-node"><i data-lucide="scissors"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">04</span><h3>Слайс и чоп семплов</h3><span class="lw-tag">Создание</span></div>
        <p>Режем сэмплы на части и собираем из них новые ритмы.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#C084FC;--pb:rgba(192,132,252,0.4);--pg:rgba(192,132,252,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">05</span><h3>Построение драмки по жанру</h3><span class="lw-tag">Структура</span></div>
        <p>Кик, снейр, хэты — ритмический каркас EDM.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#C084FC;--pb:rgba(192,132,252,0.4);--pg:rgba(192,132,252,0.35)">
      <div class="lw-node"><i data-lucide="sparkles"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">06</span><h3>Саунд-дизайн и атмосфера</h3><span class="lw-tag">Структура</span></div>
        <p>Дропы, переходы и текстуры, которые несут энергию.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="activity"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">07</span><h3>Сайдчейн и лее-ринг</h3><span class="lw-tag">Финализация</span></div>
        <p>Бас «качает» под кик, лее-ринг ведёт слушателя в дроп.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="sliders-horizontal"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">08</span><h3>Сведение + Мастеринг</h3><span class="lw-tag">Финализация</span></div>
        <p>Баланс, громкость и финальный полир.</p>
      </div>
    </li>
    <li class="lw-step lw-step--final" style="--pc:#34D399;--pb:rgba(52,211,153,0.4);--pg:rgba(52,211,153,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">09</span><h3>Финальный EDM-трек<span class="lw-eq--mini" aria-hidden="true"><i></i><i></i><i></i></span></h3><span class="lw-tag">Релиз</span></div>
        <p>Готовый трек: слушаем на разных системах и публикуем.</p>
      </div>
    </li>
    </ol>
  </div>
