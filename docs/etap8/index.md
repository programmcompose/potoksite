...
Оркестровые библиотеки, кинематографичные темы, эмбиент и сведение саундтреков.
...
<div class="lw-wrap">
  <div class="lw-head">
    ...
    <span class="lw-head__label">Pipeline · саундтрек</span>
    <span class="lw-count"><b>00</b>/12</span>
  </div>
  <div class="lw-flow">
    ...
    <li class="lw-step" style="--pc:#F2994A;--pb:rgba(242,153,74,0.4);--pg:rgba(242,153,74,0.35)">
      <div class="lw-node"><i data-lucide="clipboard-list"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">01</span><h3>Бриф и референсы</h3><span class="lw-tag">Подготовка</span></div>
        <p>Задача, настроение и референсы от заказчика.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#F2994A;--pb:rgba(242,153,74,0.4);--pg:rgba(242,153,74,0.35)">
      <div class="lw-node"><i data-lucide="library"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">02</span><h3>Подбор библиотеки Kontakt</h3><span class="lw-tag">Подготовка</span></div>
        <p>Оркестровые сэмпл-библиотеки под масштаб картины.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#F2994A;--pb:rgba(242,153,74,0.4);--pg:rgba(242,153,74,0.35)">
      <div class="lw-node"><i data-lucide="palette"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">03</span><h3>Настроение и тема</h3><span class="lw-tag">Подготовка</span></div>
        <p>Эмоциональная палитра: мажор/минор, темп, цвет.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">04</span><h3>Гармония и прогрессии</h3><span class="lw-tag">Написание</span></div>
        <p>Аккордовые основы музыкальной истории.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      <div class="lw-node"><i data-lucide="guitar"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">05</span><h3>Оркестровка инструментов</h3><span class="lw-tag">Написание</span></div>
        <p>Какой инструмент несёт какую роль.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      <div class="lw-node"><i data-lucide="pen-line"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">06</span><h3>Аранжировка и динамика</h3><span class="lw-tag">Написание</span></div>
        <p>Структура: вступление, развитие, кульминация.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#22D3EE;--pb:rgba(34,211,238,0.4);--pg:rgba(34,211,238,0.35)">
      <div class="lw-node"><i data-lucide="trending-up"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">07</span><h3>Развитие темы</h3><span class="lw-tag">Написание</span></div>
        <p>Вариации главной темы на протяжении фильма.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">08</span><h3>Сведение оркестра</h3><span class="lw-tag">Сведение</span></div>
        <p>Баланс секций и инструментов.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#60A5FA;--pb:rgba(96,165,250,0.4);--pg:rgba(96,165,250,0.35)">
      <div class="lw-node"><i data-lucide="waves"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">09</span><h3>Пространство и реверб</h3><span class="lw-tag">Сведение</span></div>
        <p>Зал, пространство и масштаб звучания.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#34D399;--pb:rgba(52,211,153,0.4);--pg:rgba(52,211,153,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">10</span><h3>Мастеринг</h3><span class="lw-tag">Финал</span></div>
        <p>Громкость и тон под стандарт кино/стриминга.</p>
      </div>
    </li>
    <li class="lw-step" style="--pc:#34D399;--pb:rgba(52,211,153,0.4);--pg:rgba(52,211,153,0.35)">
      <div class="lw-node"><i data-lucide="film"></i></div>
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">11</span><h3>Подача под картинку</h3><span class="lw-tag">Финал</span></div>
        <p>Синхронизация сцены: музыка работает на кадр.</p>
      </div>
    </li>
    <li class="lw-step lw-step--final" style="--pc:#34D399;--pb:rgba(52,211,153,0.4);--pg:rgba(52,211,153,0.35)">
      ...
      <div class="lw-card">
        <div class="lw-top"><span class="lw-num">12</span><h3>Финальный саундтрек<span class="lw-eq--mini" aria-hidden="true"><i></i><i></i><i></i></span></h3><span class="lw-tag">Финал</span></div>
        <p>Готовый трек — в картину или альбом.</p>
      </div>
    </li>
    </ol>
  </div>
...
!!! success "Тест Этапа №8"
    67 вопросов по всем темам этапа: библиотеки Kontakt, оркестровка и инструменты, написание с нуля, стандартный трек, оркестровая тема, аккорды и ритм, саундтрек под картинку и фильм, сведение и мастер, эмбиент и работа с видеорядом. Закрепи знания и навыки этапа — после каждого ответа мгновенный разбор: почему верно или где ошибся.
